% @BEGIN Bob-GrasslandWUE_yw
% @IN BIOME_BGC_BG1_Monthly_GPP_data @URI file: BIOME-BGC_BG1_Monthly_GPP.nc4
% @IN BIOME_BGC_BG1_Monthly_Evap_data @URI file: BIOME-BGC_BG1_Monthly_Evaps.nc4
% @IN C3_fraction_data @URI file: SYNMAP_PRESENTVEG_C3Grass_RelaFrac_NA_v2.0.nc
% @IN C4_fraction_data @URI file: SYNMAP_PRESENTVEG_C4Grass_RelaFrac_NA_v2.0.nc
% @IN Grass_fraction_data @URI file: SYNMAP_PRESENTVEG_Grass_Fraction_NA_v2.0.nc

% @OUT water_use_efficiency_image @URI file: water-use-efficiency.png
% @OUT tenancy_4_WUE_image @URI file: tenancy-4-WUE.png
...
% @BEGIN viz-water-use-efficiency
% @IN BIOME_BGC_BG1_Monthly_GPP_data @URI file: BIOME-BGC_BG1_Monthly_GPP.nc4
% @IN BIOME_BGC_BG1_Monthly_Evap_data @URI file: BIOME-BGC_BG1_Monthly_Evaps.nc4
% @IN C3_fraction_data @URI file: SYNMAP_PRESENTVEG_C3Grass_RelaFrac_NA_v2.0.nc
% @IN C4_fraction_data @URI file: SYNMAP_PRESENTVEG_C4Grass_RelaFrac_NA_v2.0.nc
...
% @END viz-water-use-efficiency


% @BEGIN viz-tenancy-4-WUE
...
% @END viz-tenancy-4-WUE

%% @END Bob-GrasslandWUE_yw